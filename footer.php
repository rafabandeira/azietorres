      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer-info">
            <h3><?php bloginfo('name'); ?><br><?php bloginfo('description'); ?></h3>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            ...
            <?php if (tem_area_atuacao_posts()): ?>
              <li><i class="bx bx-chevron-right"></i> <a href="/#atuacao">Atuação</a></li><?php endif; ?>
            <?php if (tem_advogado_posts()): ?>
              <li><i class="bx bx-chevron-right"></i> <a href="/#team">Advogados</a></li><?php endif; ?>
            <?php if (tem_artigos_posts()): ?>
              <li><i class="bx bx-chevron-right"></i> <a href="/artigos">Artigos</a></li><?php endif; ?>
          </ul>
        </div>
        ...
        <div class="col-lg-4 col-md-6 footer-newsletter">
          ...
          <div id="newsletter-response" style="display:none; margin-top: 10px; font-size: 14px; color: #fff;"></div>
        </div>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="copyright"> Copyright &copy; <strong><span><?php bloginfo('name'); ?> –
          <?php bloginfo('description'); ?></span></strong>. Todos os direitos reservados </div>
    <div class="credits"> Desenvolvido pela <a href="https://bandeiragroup.com.br/">BandeiraGroup Design & Web</a>
    </div>
  </div>
</footer>
<!-- End Footer -->
